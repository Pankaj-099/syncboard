...
from app.schema.task import TaskCreate, TaskUpdate, TaskStatusUpdate, TaskResponse
...
async def list_tasks(user: AuthUser = Depends(require_view), db: Session = Depends(get_db)):
