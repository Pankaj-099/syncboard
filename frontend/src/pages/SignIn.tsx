...
const clerkAppearance = {
    ...
    elements: {
        ...
        formFieldInput: {
            ...
            "&:focus": {
                border: "1px solid rgba(92, 158, 100, 0.5)",
                boxShadow: "0 0 0 3px rgba(45, 106, 53, 0.15)",
            },
        },
        formButtonPrimary: {
            ...
            transition: "all 0.2s ease",
            "&:hover": {
                background: "linear-gradient(135deg, #3d7a45, #2a5a32)",
                boxShadow: "0 4px 30px rgba(45, 106, 53, 0.5)",
        ...
        socialButtonsBlockButton: {
            ...
            border: "1px solid rgba(92, 158, 100, 0.15)",
            color: "#c5d89d",
            "&:hover": { background: "rgba(45, 106, 53, 0.15)", borderColor: "rgba(92, 158, 100, 0.3)" },
        },
        identityPreviewText: { color: "#c5d89d" },
        formFieldSuccessText: { color: "#7ab87f" },
